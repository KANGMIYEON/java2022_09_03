...
public class Collection01 {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		// indexOf(값) : 값의 위치를 반환, 값이 없으면 -1 반환
		integer = 9;
		System.out.println(list5.indexOf(integer));
		System.out.println(list5.indexOf(5)); // 값을 직접 줘도 가능
		System.out.println(list5.lastIndexOf(integer));
		...
		list5.sort(new Comparator<Integer>() { // 정렬 방법2. import, method구현
			@Override
