...
//				"String.pdf","python.gif"};
		...
		for(String tmpFile : fileName) {
			String search = tmpFile.substring(tmpFile.indexOf(".")+1); // .의 다음부터 끝까지
	...
	public static boolean isContain(String[] arr, String search) {
		...
		return false; // true 반환이 없다면 마지막에 for 다 돌고 false 반환
